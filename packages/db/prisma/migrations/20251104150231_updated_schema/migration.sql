/*
  ...
  - The values [Asian_American,East_Asian,South_East_Asian,South_Asian,Middle_Eastern] on the enum `EthenecityEnum` will be removed. If these variants are still used in the database, this will fail.
...
DROP TYPE "public"."EthenecityEnum_old";
COMMIT;
